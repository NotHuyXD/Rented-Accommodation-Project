...
import type { Bookmark, Notification, Conversation, RentalRequest, Contract, Invoice, Appointment } from '../types';
import { bookmarkApi, notificationApi, chatApi, rentalRequestApi, contractApi, invoiceApi, appointmentApi } from '../api/services';
