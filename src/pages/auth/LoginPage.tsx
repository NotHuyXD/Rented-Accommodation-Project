      ...
      <div className="auth-container">
        <div className="auth-card animate-scaleIn">
          ...
          <div className="auth-social-btns">
            <button type="button" className="btn btn-secondary auth-social-btn" onClick={() => handleSocialLogin('Google')} disabled={loading}>
            ...
            <button type="button" className="btn btn-secondary auth-social-btn" style={{ background: '#1877F2', color: 'white', border: 'none' }} onClick={() => handleSocialLogin('Facebook')} disabled={loading}>
